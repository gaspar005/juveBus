...
function getInfoOperador(operador){
    ...
    $.ajax({
        type: "POST",
        url:baseURL + "Operador_ctrl/getInfor_operador",
...
function personalizada(query) {
    ...
    switch (query) {
        ...
        case "mes":
            $.ajax({
                type: "GET",
                url: baseURL + "Operador_ctrl/getYearEsistentes",
                success: function (respuesta) {
                    var obj = JSON.parse(respuesta);
...
function consultarPorDia(){
            ...
            $.ajax({
                type: "POST",
                url:baseURL + "Operador_ctrl/searchQueryDay",
...
function consultarPorMes() {
            ...
            $.ajax({
                type: "POST",
                url:baseURL + "Operador_ctrl/searchQueryMonth",
...
function consultarPorYear(){
            ...
            $.ajax({
                type: "POST",
                url:baseURL + "Operador_ctrl/searchQueryYear",
...
function validaRFC(rfcStr) {
    ...
    $.ajax({
        type: "POST",
        url: baseURL +"Operador_ctrl/searchRFC",
        data: {rfc: rfcStr}, 
         success: function(respuesta){
           var obj = JSON.parse(respuesta);
           if (obj.resultado == true) {
...
function saveOperador(){
    ...
    $("#form_create_operador").validate({
        ...
        messages: {
            rfc: "RFC es Necesarias",
            nombre: "Nombre es Necesario",
            ap_pat: "Apellido Paterno es Necesarias",
            ap_mat: "Apellido Materno es Necesario",
            year_fecha: "*",
            mes_fecha: "*",
        ...
        submitHandler: function(){
            ...
            var formData = $("#form_create_operador").serialize();

            var l = $("#btn_guardar_operador").ladda();
            l.ladda('start');
            $.ajax({
                type: "POST",
                url:baseURL + "Operador_ctrl/guardar_operador",
                data: formData,
                success: function(respuesta) {
                  var obj = JSON.parse(respuesta);
                    if (obj.resultado === true) {
...
function saveEditOperador(){
    ...
    $("#form_edit_operdor").validate({
        ...
        submitHandler: function(){    
            ...
            $.ajax({
                type: "POST",
                url:baseURL + "Operador_ctrl/updater_operador",
                data: dataString,
                success: function(respuesta) {
                  var obj = JSON.parse(respuesta);
                    if (obj.resultado === true) {                      
...
function habilitarOperador(id, nombre, paterno, materno){
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url: baseURL + "Operador_ctrl/habilitar_operador",
            type: "POST",
            data: {id: id},
            dataType: "html",
            success: function () {
...
function deshabilitarOperador(id, nombre, paterno, materno){
   ...
   var name = "<p><strong>"+nombre+' '+paterno+ ' '+ materno+"</strong><p>";
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url: baseURL + "Operador_ctrl/deshabilitar_operador",
            type: "POST",
            data: {id: id},
            dataType: "html",
            success: function () {
