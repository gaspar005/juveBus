...
function saveEstudent(){
	$("#form_crear_estudiante").validate({
        ...
        submitHandler: function(){
            ...
            $.ajax({
                type: "POST",
                url:baseURL + "Estudiantes_ctrl/guardar_estudiante",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
...
function validarCJ(codigoJ){
   ...
   $.ajax({
      type: "POST",
      url: baseURL + "Estudiantes_ctrl/buscar_codigojoven",
...
function deshabilitarEstudiante(id, nombre, paterno, materno) {
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url: baseURL + "Estudiantes_ctrl/deshabilitar_Estudiante",
            type: "POST",
            data: {id: id},
            dataType: "html",
            success: function () {
...
function habilitarEstudiante(id, nombre, paterno, materno) {
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url: baseURL + "Estudiantes_ctrl/habilitar_Estudiante",
            type: "POST",
            data: {id: id},
            dataType: "html",
            success: function () {
...
function saveEditEstudiante(){
    ...
    $("#form_edit_estudiante").validate({
        ...
        submitHandler: function(){
            ...
            $.ajax({
                type: "POST",
                url:baseURL + "Estudiantes_ctrl/guardar_estudiante_edit",
                data: dataString,
                success: function(respuesta) {
                    var obj = JSON.parse(respuesta);
