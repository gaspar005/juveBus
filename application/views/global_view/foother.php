...
================================================== -->
<!--VALIDAR INPUTS FORM -->
<script src="<?php echo base_url('assets/js/plugins/validator/validation.es6.js'); ?>"></script>
...
<script src="<?php echo base_url('assets/js/jquery-1.7.2.min.js'); ?>"></script> <!-- es importante no quitar -->
...
<script src="<?php echo base_url('assets/js/validations/web/main_generico.js'); ?>"></script>

<!-- js empleado -->
<script src="<?php echo base_url('assets/js/validations/web/estudiante.js'); ?>"></script>
